        ...
        <Sheet>
            <SheetTrigger asChild >
                <Button variant="outline" className="relative">
                    {cart.length !== 0 && (<Badge className="absolute top-0 -right-2 w-4 h-5 flex items-center justify-center" variant="default">{cart.length}</Badge>)}
                    <Icons.Cart />
                </Button>
            </SheetTrigger>
            <SheetContent >
                ...
                {cart.length !== 0 ? (
                    ...
                    <div className="flex flex-col justify-center items-center w-full h-full text-2xl space-y-5">
